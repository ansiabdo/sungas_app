...
def _execute(filters=None, additional_table_columns=None, additional_query_columns=None):
	...
	bundle_list=frappe.db.sql("""select parent,item_code,qty from `tabProduct Bundle Item` where item_code="LPG-20180001";""",as_list=1)
	bundle={}
	...
	for d in item_list:
		...
		row = [d.item_code, d.item_name, d.item_group,
			# d.description,
			 d.parent, d.posting_date, d.customer, d.customer_name]
		...
		row += [
			...
			delivery_note,
			# d.income_account,
			 d.cost_center, d.stock_qty, d.stock_uom,in_kg,d.owner
		]
...
def get_columns(additional_table_columns):
	...
	columns += [
		...
		_("Stock Qty") + ":Float:120", _("Stock UOM") + "::100","Stock in KG:Float:120","Created by:Data:120",
